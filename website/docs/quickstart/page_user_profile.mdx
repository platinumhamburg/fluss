...
CREATE TEMPORARY TABLE page_views (
    ...
    'fields.email.expression'      =
        'user#{number.numberBetween ''1'',''500''}@example.com',
...
|               email |  uid |
+---------------------+------+
|  user77@example.com | 1740 |
|   user1@example.com |  927 |
|   user9@example.com |  912 |
|   user3@example.com | 1525 |
| user201@example.com |   89 |
|  user15@example.com | 1371 |
| user302@example.com | 1657 |
|  user12@example.com |  234 |
|  user45@example.com |  891 |
|  user78@example.com | 1102 |
+---------------------+------+
10 rows in set
```
