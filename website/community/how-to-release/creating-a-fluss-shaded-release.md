...
(5) Verify the files are present: https://dist.apache.org/repos/dist/dev/fluss/
...
- Source distribution deployed to the dev repository of [dist.apache.org](https://dist.apache.org/repos/dist/dev/fluss/)
...
Subject: [VOTE] Release fluss-shaded 1.0 (RC3)

Hi everyone,

Please review and vote on the release candidate #3 for the fluss-shaded version 1.0, as follows:
...
* source code tag "release-1.0-rc3" [4],
...
[1] link
[2] https://dist.apache.org/repos/dist/release/fluss/KEYS
[3] link
[4] link
```
...
From: Release Manager
To: dev@fluss.apache.org
Subject: [RESULT][VOTE] Release fluss-shaded 1.0 (RC3)
...
```bash
svn move -m "Release Fluss Shaded ${RELEASE_VERSION}" https://dist.apache.org/repos/dist/dev/fluss/fluss-shaded-${RELEASE_VERSION}-rc${RC_NUM} https://dist.apache.org/repos/dist/release/fluss/fluss-shaded-${RELEASE_VERSION}
```
...
Subject: [ANNOUNCE] Apache Fluss Shaded 1.0 released

The Apache Fluss community is very happy to announce the release of Apache Fluss Shaded 1.0.
...
https://downloads.apache.org/fluss/fluss-shaded-1.0/
