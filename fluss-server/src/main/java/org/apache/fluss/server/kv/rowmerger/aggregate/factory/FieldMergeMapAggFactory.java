...
import org.apache.fluss.server.kv.rowmerger.aggregate.functions.FieldMergeMapAgg;
...
public class FieldMergeMapAggFactory implements FieldAggregatorFactory {
    ...
    @Override
    public FieldMergeMapAgg create(DataType fieldType, AggFunction aggFunction) {
        checkArgument(
                fieldType instanceof MapType,
                "Data type for merge_map column must be 'MapType' but was '%s'.",
                fieldType);
    ...
    public String identifier() {
        return AggFunctionType.MERGE_MAP.toString();
    }
}
