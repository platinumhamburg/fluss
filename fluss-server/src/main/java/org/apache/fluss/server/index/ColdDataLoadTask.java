    ...
    public void execute() throws Exception {
        try {
            ...
            if (callback != null) {
                ...
                // Don't re-throw: onFailure already handled recovery
                // (reset coldLoadState and re-evaluated cold loading).
                // Re-throwing would cause the scheduler to retry this task,
                // potentially duplicating work with the new task from re-evaluation.
                return;
            }
            throw e;
        }
