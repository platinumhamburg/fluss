...
public final class Replica {
    ...
    private void createKvLazy() {
        ...
        if (tableConfig.getChangelogImage() == ChangelogImage.WAL) {
            ...
            Long snapshotRowCount =
                    getLatestSnapshot(tableBucket).map(CompletedSnapshot::getRowCount).orElse(null);
    ...
    private void startPeriodicKvSnapshot(
            KvTablet snapshotTablet, @Nullable CompletedSnapshot completedSnapshot) {
        ...
        try {
            ...
            rocksIncrementalSnapshot =
                    snapshotTablet.createIncrementalSnapshot(
                            uploadedSstFiles,
            ...
            this.kvSnapshotManager =
                    PeriodicSnapshotManager.create(
                            ...
                            kvTabletSnapshotTarget,
                            snapshotContext,
                            snapshotTablet.getGuardedExecutor());
