...
public class TabletState {
    ...
    private static final TabletState EMPTY = new TabletState(0, null, null, null);
    ...
    /** Returns an empty TabletState with default values. */
    public static TabletState empty() {
        return EMPTY;
    }
