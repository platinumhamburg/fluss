...
public class ServerRpcMessageUtils {
    ...
    public static AcquireColumnLockResponse makeAcquireColumnLockResponse(
        ...
        // Build lock request for table level
        long tableId = request.getTableId();
        ...
        org.apache.fluss.server.lock.ServerColumnLockService.TableLockRequest lockRequest =
                new org.apache.fluss.server.lock.ServerColumnLockService.TableLockRequest(
                        tableId, ownerId, schemaId, columnIndexes, ttlMs);

        // Acquire lock at table level
        org.apache.fluss.server.lock.ServerColumnLockService.TableLockResult result =
    ...
    public static RenewColumnLockResponse makeRenewColumnLockResponse(
        ...
        org.apache.fluss.server.lock.ServerColumnLockService.TableLockResult result =
                serverColumnLockService.renewLockForTable(tableId, ownerId);
    ...
    public static ReleaseColumnLockResponse makeReleaseColumnLockResponse(
        ...
        // Release lock at table level
        serverColumnLockService.releaseLockForTable(tableId, ownerId);
