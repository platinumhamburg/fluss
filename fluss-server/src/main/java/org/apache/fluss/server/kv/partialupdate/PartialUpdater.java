...
public class PartialUpdater {
     ...
     *       it applies to ALL non-PK columns regardless of whether they appear in {@code
     *       targetColumns}. This forbids the configuration that would let {@link
     *       #updateRow(BinaryValue, BinaryValue)} legitimately produce a NOT NULL column whose
     *       value is null (either because it is absent from the partial-update target set, or
     *       because the old row from an evolved schema lacked it).
     * </ol>
     *
