...
/** First non-null value aggregator - keeps the first seen non-null value. */
public class FieldFirstNonNullValueAgg extends FieldAggregator {
    ...
    public Object agg(Object accumulator, Object inputField) {
        ...
        // If accumulator is non-null, it's the first non-null value, keep it
        if (accumulator != null) {
            if (!initialized) {
                initialized = true;
            }
        ...
        // If accumulator is null but inputField is non-null, this is the first non-null value
        if (inputField != null && !initialized) {
            initialized = true;
        }
        // Return inputField (which becomes the new accumulator if it's non-null)
        return inputField;
    }
