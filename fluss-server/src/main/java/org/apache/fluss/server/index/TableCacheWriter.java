...
public final class TableCacheWriter implements Closeable {
     ...
     * empty row writes.
     *
     * <p>The targetOffset parameter should be batchEndOffset (next offset to process) rather than
     * the last processed offset. This ensures that buckets with real data won't be skipped during
     * synchronization, preventing range gaps.
     *
     * @param targetOffset the target offset to synchronize to (typically batchEndOffset)
