...
public class DataBucketIndexFetchStatus {
    ...
    private final @Nullable IndexApplier indexApplier;
    ...
    public DataBucketIndexFetchStatus(
            ...
            @Nullable IndexApplier indexApplier) {
     ...
     */
    public IndexApplier.IndexApplyStatus getIndexApplyStatus() {
        TableBucket dataBucket = dataIndexTableBucket.getDataBucket();
    ...
    public long getFetchOffset() {
        IndexApplier.IndexApplyStatus status = getIndexApplyStatus();
