...
public final class AggregateFieldsProcessor {
    ...
    /** Field operation: applies aggregator.agg(accumulator, input). */
    private static final FieldOperation AGG_OP = FieldAggregator::agg;
    ...
    public static void aggregateAllFieldsWithTargetSchema(
        ...
        processAllFieldsWithTargetSchema(
                oldRow, newRow, oldContext, newInputContext, targetContext, encoder, AGG_OP, false);
    }
