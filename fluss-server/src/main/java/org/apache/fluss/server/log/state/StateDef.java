...
import org.apache.fluss.server.log.state.transitions.IndexApplyStateTransition;

/** A definition of a state. */
public enum StateDef {
    INDEX_APPLY_STATE("index_apply_state", new IndexApplyStateTransition() {}, false);
    ...
    StateDef(String namespace, StateTransition transition, boolean headerOnly) {
