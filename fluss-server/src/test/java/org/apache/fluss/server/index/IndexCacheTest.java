...
final class IndexCacheTest {
    ...
    @Test
    void testCacheIndexDataFromLog() throws Exception {
        ...
        indexCache.cacheIndexDataFromLog(walRecords, appendInfo);
    ...
    @Test
    void testCacheIndexDataFromLogWhenClosed() throws Exception {
