...
class FieldAggregatorParameterizedTest {
    ...
    void testSumAggregation(
        ...
        BinaryRow merged = merger.merge(row1, row2);

        // Verify result based on data type
        assertThat(merged.getInt(0)).isEqualTo(1); // id stays the same
        assertAggregatedValue(merged, 1, dataType, expected);
    }
    ...
    void testSumAggregationWithNull(
        ...
        BinaryRow merged2 = merger.merge(row3, row4);
        assertAggregatedValue(merged2, 1, dataType, expected);
    }
    ...
    void testProductAggregation(
        ...
        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "product");
        TableConfig tableConfig = new TableConfig(conf);
    ...
    void testMaxAggregation(
        ...
        Configuration confMax = new Configuration();
        confMax.setString("table.merge-engine.aggregate.value", "max");
        TableConfig tableConfigMax = new TableConfig(confMax);
        ...
        BinaryRow mergedMax = mergerMax.merge(row1, row2);

        assertThat(mergedMax.getInt(0)).isEqualTo(1);
        assertAggregatedValue(mergedMax, 1, dataType, expectedMax);
        ...
        Configuration confMin = new Configuration();
        confMin.setString("table.merge-engine.aggregate.value", "min");
        TableConfig tableConfigMin = new TableConfig(confMin);
        ...
        BinaryRow mergedMin = mergerMin.merge(row3, row4);

        assertThat(mergedMin.getInt(0)).isEqualTo(1);
        assertAggregatedValue(mergedMin, 1, dataType, expectedMin);
    }
    ...
    void testLastValueAggregation(
        ...
        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "last_value");
        TableConfig tableConfig = new TableConfig(conf);
        ...
        BinaryRow merged1 = merger.merge(row1, row2);
        assertAggregatedValue(merged1, 1, dataType, val2);

        // Second merge: last value should be val3
        BinaryRow merged2 = merger.merge(merged1, row3);
        assertAggregatedValue(merged2, 1, dataType, val3);
    }
    ...
    @ParameterizedTest(name = "last_non_null_value with {0}")
    ...
    void testLastNonNullValueAggregation(String typeName, DataType dataType, Object val) {
        ...
        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "last_non_null_value");
        TableConfig tableConfig = new TableConfig(conf);
        ...
        BinaryRow merged = merger.merge(row1, row2);
        assertAggregatedValue(merged, 1, dataType, val);
    }
    ...
    void testFirstValueAggregation(String typeName, DataType dataType, Object val1, Object val2) {
        ...
        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "first_value");
        TableConfig tableConfig = new TableConfig(conf);
        ...
        BinaryRow merged = merger.merge(row1, row2);
        assertAggregatedValue(merged, 1, dataType, val1);
    }
    ...
    @ParameterizedTest(name = "first_non_null_value with {0}")
    ...
    void testFirstNonNullValueAggregation(String typeName, DataType dataType, Object val) {
        ...
        BinaryRow merged2 = merger.merge(row3, row4);
        assertAggregatedValue(merged2, 1, dataType, val);
    }
    ...
    void testBoolAndAggregation() {
        Schema schema =
                Schema.newBuilder()
                        .column("id", DataTypes.INT())
                        .column("value", DataTypes.BOOLEAN())
                        .primaryKey("id")
                        .build();

        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "bool_and");
        TableConfig tableConfig = new TableConfig(conf);
        ...
        BinaryRow merged1 = merger.merge(row1, row2);
        assertThat(merged1.getBoolean(1)).isTrue();
        ...
        BinaryRow merged2 = merger.merge(row3, row4);
        assertThat(merged2.getBoolean(1)).isFalse();
        ...
        BinaryRow merged3 = merger.merge(row5, row6);
        assertThat(merged3.getBoolean(1)).isFalse();
    }
    ...
    void testBoolOrAggregation() {
        ...
        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "bool_or");
        TableConfig tableConfig = new TableConfig(conf);
        ...
        BinaryRow merged1 = merger.merge(row1, row2);
        assertThat(merged1.getBoolean(1)).isFalse();

        // true OR false = true
        BinaryRow row3 = compactedRow(schema.getRowType(), new Object[] {1, true});
        BinaryRow row4 = compactedRow(schema.getRowType(), new Object[] {1, false});
        BinaryRow merged2 = merger.merge(row3, row4);
        assertThat(merged2.getBoolean(1)).isTrue();
        ...
        BinaryRow merged3 = merger.merge(row5, row6);
        assertThat(merged3.getBoolean(1)).isTrue();
    }
    ...
    void testBoolAndWithNull() {
        ...
        BinaryRow row2 = compactedRow(schema.getRowType(), new Object[] {1, true});
        BinaryRow merged = merger.merge(row1, row2);
        assertThat(merged.getBoolean(1)).isTrue();
    }
    ...
    void testBoolOrWithNull() {
        ...
        BinaryRow row2 = compactedRow(schema.getRowType(), new Object[] {1, false});
        BinaryRow merged = merger.merge(row1, row2);
        assertThat(merged.getBoolean(1)).isFalse();
    }
    ...
    void testListaggAggregation() {
        ...
        Configuration conf = new Configuration();
        conf.setString("table.merge-engine.aggregate.value", "listagg");
        TableConfig tableConfig = new TableConfig(conf);
        ...
        BinaryRow merged1 = merger.merge(row1, row2);
        assertThat(merged1.getString(1).toString()).isEqualTo("apple,banana");

        BinaryRow merged2 = merger.merge(merged1, row3);
        assertThat(merged2.getString(1).toString()).isEqualTo("apple,banana,cherry");
    }
    ...
    void testListaggWithCustomDelimiter() {
        ...
        BinaryRow merged1 = merger.merge(row1, row2);
        assertThat(merged1.getString(1).toString()).isEqualTo("a|b");

        BinaryRow merged2 = merger.merge(merged1, row3);
        assertThat(merged2.getString(1).toString()).isEqualTo("a|b|c");
    }
    ...
    void testListaggWithNull() {
        ...
        BinaryRow merged1 = merger.merge(row1, row2);
        assertThat(merged1.getString(1).toString()).isEqualTo("a");

        BinaryRow merged2 = merger.merge(merged1, row3);
        assertThat(merged2.getString(1).toString()).isEqualTo("a,b");
    }
    ...
    private AggregateRowMerger createMerger(Schema schema, TableConfig tableConfig) {
        ...
        return new AggregateRowMerger(
                ...
                tableConfig
                        .getDeleteBehavior()
                        .orElse(org.apache.fluss.metadata.DeleteBehavior.IGNORE),
