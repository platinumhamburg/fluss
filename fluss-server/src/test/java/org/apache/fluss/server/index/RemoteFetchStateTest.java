...
class RemoteFetchStateTest {
    ...
    void testInitialState() {
        ...
        assertThat(state.getIndexBucketLeaderServerId()).isEqualTo(-1);
    }
    ...
    void testMultipleCommitOffsetUpdates() {
        ...
        assertThat(state.getIndexBucketLeaderServerId()).isEqualTo(2);
    ...
    void testLargeOffsetValues() {
        ...
        assertThat(state.getIndexBucketLeaderServerId()).isEqualTo(Integer.MAX_VALUE);
    }
}
