...
class PartitionChangeWatcherTest {
    ...
    void testStartAndGetCurrentPartitions() throws Exception {
        ...
        List<PartitionInfo> createdPartitions = new CopyOnWriteArrayList<>();
        List<PartitionInfo> deletedPartitions = new CopyOnWriteArrayList<>();
    ...
    void testCloseStopsEvents() throws Exception {
        ...
        retry(Duration.ofMillis(500), () -> assertThat(createdPartitions).isEmpty());
    }
    ...
    private void createPartition(String partitionName, long partitionId) throws Exception {
        ...
        PartitionRegistration partition = new PartitionRegistration(TABLE_ID, partitionId, null);
