...
class SingleIndexExtractorTest {
    ...
    void testContinueProcessingAfterNullRecord() throws Exception {
        ...
        // The total entries should be at least 3 (from valid records) + entries from finalizeBatch
        // Since finalizeBatch synchronizes all buckets, we check that entries >= 3
        assertThat(cacheManager.getTotalEntries()).isGreaterThanOrEqualTo(3);
