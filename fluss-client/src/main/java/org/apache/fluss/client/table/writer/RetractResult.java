...
/**
 * The result of retracting a record ({@link UpsertWriter#retract(InternalRow)}).
 *
 * @since 0.10
 */
@PublicEvolving
public class RetractResult {
     ...
     *
     * @param bucket the bucket this retract was written to
     * @param logEndOffset the log end offset (LEO) after this write, i.e., the offset of the next
     *     record to be written
     */
    public RetractResult(@Nullable TableBucket bucket, long logEndOffset) {
        this.bucket = bucket;
        this.logEndOffset = logEndOffset;
    }

    /**
     * Returns the bucket this retract was written to.
     *
    ...
    public static RetractResult empty() {
        return new RetractResult(null, -1);
    }
}
