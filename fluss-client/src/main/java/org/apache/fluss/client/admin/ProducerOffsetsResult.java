...
public class ProducerOffsetsResult {
    ...
    /**
     * Get the offset snapshot for a specific table.
     *
     * @param tableId the ID of the table
     * @return map of TableBucket to offset, or null if table not found
     */
    @Nullable
    public Map<TableBucket, Long> getOffsetsForTable(long tableId) {
        return tableOffsets.get(tableId);
    }
