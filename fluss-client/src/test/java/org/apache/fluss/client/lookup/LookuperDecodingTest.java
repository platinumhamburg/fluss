...
class LookuperDecodingTest {
    ...
    void testKvTtlEncodedValueCanBeDecodedInLookupPath() {
        ...
        TestLookuper lookuper =
                new TestLookuper(
                        tableInfo, null, // MetadataUpdater not used in decodeValues path
                        null, // LookupClient not used in decodeValues path
                        null); // SchemaGetter not used when all records match target schema
