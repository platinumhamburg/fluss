...
class RpcListStatusTest {

    @Test
    void preservesRpcFailureCategoryForScopeClassification() {
        LogActiveRefsFetchResult result =
                LogActiveRefsFetchResult.listFailed(
                        RpcErrorClassifier.Category.NOT_FOUND, "partition disappeared");
