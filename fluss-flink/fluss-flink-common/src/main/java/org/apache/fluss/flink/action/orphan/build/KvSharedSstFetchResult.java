 ...
 *
 * <ul>
 *   <li><b>OK</b>: All active snapshot metadata reads succeeded; {@link #sharedSstFileNames()}
 *       contains the union of remote shared SST object basenames referenced by active snapshots.
 *   <li><b>Not found</b>: Snapshot metadata disappeared; the caller may refresh once.
 *   <li><b>Target disappeared</b>: The refreshed snapshot list confirms that the table or partition
 *       no longer exists.
