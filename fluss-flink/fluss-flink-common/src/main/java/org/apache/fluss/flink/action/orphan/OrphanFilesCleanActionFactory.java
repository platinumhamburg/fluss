...
public class OrphanFilesCleanActionFactory implements ActionFactory {
    ...
    public String help() {
        return "Usage: remove_orphan_files --bootstrap-server <host:port>\n"
                ...
                + "  [--scope-enumeration-concurrency 1]\n"
                ...
                + "  --scope-enumeration-concurrency controls target-level scope enumeration;\n"
                + "    --parallelism applies only to ScanAndClean. Both remain bounded by the\n"
                + "    configured remote-FS rate.\n"
