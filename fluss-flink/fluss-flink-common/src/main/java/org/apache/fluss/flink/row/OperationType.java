...
public enum OperationType {
    ...
    /**
     * Retract operation — sent as a record with {@link
     * org.apache.fluss.record.MutationType#RETRACT} in PUT_KV V2 format. Used for aggregation merge
     * engine tables where all non-PK columns support retract.
     */
    RETRACT,
