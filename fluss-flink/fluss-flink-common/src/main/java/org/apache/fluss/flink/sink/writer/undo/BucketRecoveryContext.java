...
public class BucketRecoveryContext {
     ...
     *   <li>We have processed records up to logEndOffset - 1 (since offsets are 0-indexed and log
    ...
    public boolean isComplete() {
        ...
        // We're complete when we've processed up to logEndOffset - 1
        // (logEndOffset is exclusive, so we need to read records from checkpointOffset to
        // logEndOffset - 1)
