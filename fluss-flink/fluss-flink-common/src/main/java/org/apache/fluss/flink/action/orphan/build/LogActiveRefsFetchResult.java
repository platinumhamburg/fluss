...
public final class LogActiveRefsFetchResult {
    ...
    public enum ManifestReadStatus {
         ...
         * did not include an entry for it. A successful RPC reads the current per-bucket manifest
         * handles from coordinator metadata, so this means that the bucket has not committed a
