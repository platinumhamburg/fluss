...
/** Bounded filesystem probes that distinguish a disappeared path from an I/O failure. */
@Internal
public final class FileSystemProbe {
    ...
    private static FileStatus[] requireListing(FileStatus[] listing, FsPath path)
            throws IOException {
        if (listing == null) {
