...
public class LogRecordBatchFormat {
     ...
     *
     * <ul>
     *   <li>Set StatisticsOffset field to 0 (no statistics)
     ...
     */
    public static void clearStatisticsFromHeader(java.nio.ByteBuffer headerBuffer, byte magic) {
        if (magic != LOG_MAGIC_VALUE_V2) {
            return;
        }

        // Set StatisticsOffset to 0 (no statistics)
        headerBuffer.position(statisticsOffsetOffset(magic));
