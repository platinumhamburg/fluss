...
public final class TestData {
    ...
    public static final List<Tuple2<Object[], Object[]>> IDX_NAME_DATA_WITH_KEY_AND_VALUE =
            Arrays.asList(
                    Tuple2.of(new Object[] {"Alice", 1}, new Object[] {"Alice", 1}),
                    Tuple2.of(new Object[] {"Bob", 2}, new Object[] {"Bob", 2}),
                    Tuple2.of(new Object[] {"Charlie", 3}, new Object[] {"Charlie", 3}),
                    Tuple2.of(new Object[] {"Diana", 4}, new Object[] {"Diana", 4}),
                    Tuple2.of(new Object[] {"Eve", 5}, new Object[] {"Eve", 5}));
    ...
    public static final TableDescriptor PARTITIONED_INDEXED_TABLE_DESCRIPTOR =
            TableDescriptor.builder()
                    ...
                    .property("table.auto-partition.time-unit", "year")
                    .build();
