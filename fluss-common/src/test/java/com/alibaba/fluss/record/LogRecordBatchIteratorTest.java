...
public class LogRecordBatchIteratorTest {
    ...
    void testFilteredLogRecordBatchIteratorWithStatisticsValidation() throws Exception {
        ...
        // Verify minimum value (minimum value of first field in DATA1 is 1)
        assertThat(statistics.getMinValues().getInt(0)).isEqualTo(1);

        // Verify maximum value (maximum value of first field in DATA1 is 10)
        assertThat(statistics.getMaxValues().getInt(0)).isEqualTo(10);

        // Verify null count (no null values in DATA1)
    ...
    @Test
    void testGetStatisticsWithReadContext() throws Exception {
        // Create test data with statistics
        MemoryLogRecords memoryLogRecords =
                LogRecordBatchTestUtils.createLogRecordsWithStatistics(
                        DATA1, DATA1_ROW_TYPE, 0L, DEFAULT_SCHEMA_ID);
        ...
        // Test the getStatistics(ReadContext) method
