...
public enum ApiKeys {
    ...
    UPDATE_METADATA(1013, 0, 1, PRIVATE),
    ...
    NOTIFY_LEADER_AND_ISR(1018, 0, 1, PRIVATE),
    STOP_REPLICA(1019, 0, 1, PRIVATE),
    ADJUST_ISR(1020, 0, 0, PRIVATE),
    LIST_OFFSETS(1021, 0, 0, PUBLIC),
    COMMIT_KV_SNAPSHOT(1022, 0, 1, PRIVATE),
    ...
    COMMIT_REMOTE_LOG_MANIFEST(1027, 0, 1, PRIVATE),
    ...
    LIST_REMOTE_LOG_MANIFESTS(1063, 0, 1, PUBLIC),
    ...
    GET_BULK_LOAD_STATUS(1068, 0, 0, PUBLIC);
