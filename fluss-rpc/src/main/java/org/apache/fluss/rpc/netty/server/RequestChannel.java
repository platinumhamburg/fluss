...
public class RequestChannel {
    ...
    public void putRequest(RpcRequest request) {
        ...
        // After adding request, check if we need to pause all channels
     ...
     *
     * <p>CRITICAL: Uses a lock to ensure that state check and task submission are atomic,
     * preventing permanent channel blocking.
     *
    ...
    public void registerChannel(Channel channel) {
        ...
        // CRITICAL: Lock protects the state check and task submission as an atomic operation.
                        ...
                        .execute(
                                () -> {
                                    if (channel.config().isAutoRead()) {
                                        ...
                                        LOG.warn(
                                                "Newly registered channel {} immediately paused due to active backpressure (queue: {}, threshold: {})",
