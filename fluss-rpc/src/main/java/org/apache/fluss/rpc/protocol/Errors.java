...
public enum Errors {
    ...
    INDEX_REPLICATE_DELAYED_EXCEPTION(
            57, "The index replicate pressure is too high.", IndexReplicateDelayedException::new),
    FETCH_INDEX_EARLY_FIRE_EXCEPTION(
            58, "The fetch index is early fire.", FetchIndexEarlyFireException::new);
